...
in {
  options.horizon.user = with types; {
    name = mkOpt str "eric" "The name to use for the user account.";
    fullName = mkOpt str "Eric Ripa" "The full name of the user.";
    email = mkOpt str "eric@Ripa.io" "The email of the user.";
    initialPassword =
      mkOpt str "password"
